...
import fun.bm.interfaceprotectionrtm.config.flags.*;
import fun.bm.interfaceprotectionrtm.enums.EnumConfigCategory;
import fun.bm.interfaceprotectionrtm.utils.ClassLoadUtil;
...
public class ConfigsInstance {
    ...
    public Map<IConfigModule, Set<Exception>> getAllInstanced() {
        return allInstanced;
    }
}
